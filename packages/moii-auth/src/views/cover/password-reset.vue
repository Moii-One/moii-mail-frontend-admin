            ...
            >
                ...
                <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                    ...
                    <div class="w-full max-w-[440px] lg:mt-16">
                        ...
                        <!-- Success Message -->
                        <div v-if="emailSent" class="mb-6 p-4 bg-success/10 border border-success/20 rounded-md">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 bg-success/20 rounded-full flex items-center justify-center">
                                    <icon-mail class="w-4 h-4 text-success" />
                                </div>
                                <div>
                                    <p class="text-success font-medium">Reset email sent!</p>
                                    <p class="text-sm text-success/80">Check your email for reset instructions.</p>
                                </div>
                            </div>
                        </div>
                        
                        <form v-if="!emailSent" class="space-y-5" @submit.prevent="submitForm">
                            <div>
