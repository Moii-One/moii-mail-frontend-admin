                        ...
                        <form class="space-y-5 dark:text-white" @submit.prevent="submitForm">
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input id="Name" v-model="form.name" type="text" placeholder="Enter Name" class="form-input ps-10 placeholder:text-white-dark" />
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input id="Email" v-model="form.email" type="email" placeholder="Enter Email" class="form-input ps-10 placeholder:text-white-dark" />
                                    <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                        <icon-mail :fill="true" />
                                    </span>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input id="Password" v-model="form.password" :type="showPassword ? 'text' : 'password'" placeholder="Enter Password" class="form-input ps-10 pr-10 placeholder:text-white-dark" />
                                    <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                        <icon-lock-dots :fill="true" />
                                    </span>
                                    <button type="button" @click="showPassword = !showPassword" class="absolute ltr:right-4 rtl:left-4 top-1/2 -translate-y-1/2 text-white-dark hover:text-primary z-10">
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input id="PasswordConfirmation" v-model="form.password_confirmation" :type="showPasswordConfirmation ? 'text' : 'password'" placeholder="Confirm Password" class="form-input ps-10 pr-10 placeholder:text-white-dark" />
                                    <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                        <icon-lock-dots :fill="true" />
                                    </span>
                                    <button type="button" @click="showPasswordConfirmation = !showPasswordConfirmation" class="absolute ltr:right-4 rtl:left-4 top-1/2 -translate-y-1/2 text-white-dark hover:text-primary z-10">
                            ...
                            <div class="text-center mt-4">
                                <router-link 
                                    to="/temporary-login" 
                                    class="btn btn-outline-primary w-full border uppercase"
                                >
                                    Try for Free
                                </router-link>
                            </div>
...
<script lang="ts" setup>
    ...
    const submitForm = async () => {
        const result = await authStore.register(form.name, form.email, form.password, form.password_confirmation);
        if (result.success) {
            router.push('/login');
        }
    };
